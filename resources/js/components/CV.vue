<template>
    <div>
        ...
        <div class="eduction mt-12">
            <h2 class="text-xl font-bold">Genoten opleidingen:</h2>
            <div class="eduction-1 mt-4">
                <p><span class="font-bold">MBO 3: ICT beheer</span> <br>(Scalda Vlissingen 2016 t/m 2018) </p>
            </div>
            <div class="eduction-2 mt-4">
                <p><span class="font-bold">MBO 4: Software Developer</span> <br> (Grafisch Lyceum Rotterdam 2018 t/m 2021)</p>
            </div>
        </div>
